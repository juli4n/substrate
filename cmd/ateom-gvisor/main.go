...
func (s *AteomService) RunWorkload(ctx context.Context, req *ateompb.RunWorkloadRequest) (resp *ateompb.RunWorkloadResponse, retErr error) {
	...
	s.actorLogger.EmitLifecycleLog("Actor starting", req.GetAtespace(), req.GetActorId())
	...
	for _, ac := range req.GetSpec().GetContainers() {
		pw, err := s.actorLogger.StartJSONLogPipe(req.GetAtespace(), req.GetActorId(), ac.GetName())
		if err != nil {
	...
	s.actorLogger.EmitLifecycleLog("Actor started", req.GetAtespace(), req.GetActorId())
...
func (s *AteomService) CheckpointWorkload(ctx context.Context, req *ateompb.CheckpointWorkloadRequest) (*ateompb.CheckpointWorkloadResponse, error) {
	...
	s.actorLogger.EmitLifecycleLog("Actor checkpointing", req.GetAtespace(), req.GetActorId())
	...
	s.actorLogger.EmitLifecycleLog("Actor checkpointed", req.GetAtespace(), req.GetActorId())
...
func (s *AteomService) RestoreWorkload(ctx context.Context, req *ateompb.RestoreWorkloadRequest) (resp *ateompb.RestoreWorkloadResponse, retErr error) {
	...
	s.actorLogger.EmitLifecycleLog("Actor restoring", req.GetAtespace(), req.GetActorId())
	...
	s.actorLogger.EmitLifecycleLog("Actor restored", req.GetAtespace(), req.GetActorId())
