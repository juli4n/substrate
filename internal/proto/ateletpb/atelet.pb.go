...
type RunRequest struct {
	...
	SandboxAssets *SandboxAssets `protobuf:"bytes,5,opt,name=sandbox_assets,json=sandboxAssets,proto3" json:"sandbox_assets,omitempty"`
...
type RestoreRequest struct {
	...
	Spec *WorkloadSpec  `protobuf:"bytes,4,opt,name=spec,proto3" json:"spec,omitempty"`
	Type CheckpointType `protobuf:"varint,5,opt,name=type,proto3,enum=atelet.CheckpointType" json:"type,omitempty"`
	// The checkpoint configuration, depending on the type.
	//
	// Types that are valid to be assigned to Config:
	//
	...
	Scope         SnapshotScope `protobuf:"varint,8,opt,name=scope,proto3,enum=atelet.SnapshotScope" json:"scope,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RestoreRequest_LocalConfig struct {
	LocalConfig *LocalCheckpointConfiguration `protobuf:"bytes,6,opt,name=local_config,json=localConfig,proto3,oneof"`
}

type RestoreRequest_ExternalConfig struct {
	ExternalConfig *ExternalCheckpointConfiguration `protobuf:"bytes,7,opt,name=external_config,json=externalConfig,proto3,oneof"`
}
...
const file_atelet_proto_rawDesc = "" +
	"\n" +
	"\fatelet.proto\x12\x06atelet\"\xd5\x01\n" +
	"\n" +
	"RunRequest\x12(\n" +
	...
	"\x0esandbox_assets\x18\x05 \x01(\v2\x15.atelet.SandboxAssetsR\rsandboxAssets\"5\n" +
	"\tAssetFile\x12\x10\n" +
	...
	"\x06config\"\x14\n" +
	"\x12CheckpointResponse\"\x9d\x03\n" +
	"\x0eRestoreRequest\x12(\n" +
	"\x10target_ateom_uid\x18\x01 \x01(\tR\x0etargetAteomUid\x12\x1a\n" +
	"\batespace\x18\x02 \x01(\tR\batespace\x12\x19\n" +
	"\bactor_id\x18\x03 \x01(\tR\aactorId\x12(\n" +
	"\x04spec\x18\x04 \x01(\v2\x14.atelet.WorkloadSpecR\x04spec\x12*\n" +
	"\x04type\x18\x05 \x01(\x0e2\x16.atelet.CheckpointTypeR\x04type\x12I\n" +
	"\flocal_config\x18\x06 \x01(\v2$.atelet.LocalCheckpointConfigurationH\x00R\vlocalConfig\x12R\n" +
	"\x0fexternal_config\x18\a \x01(\v2'.atelet.ExternalCheckpointConfigurationH\x00R\x0eexternalConfig\x12+\n" +
	"\x05scope\x18\b \x01(\x0e2\x15.atelet.SnapshotScopeR\x05scopeB\b\n" +
	"\x06config\"\x11\n" +
