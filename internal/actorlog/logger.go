...
func (al *ActorLogger) EmitLifecycleLog(msg, atespace, actorID string) {
...
// tag is meaningful.
func (al *ActorLogger) StartJSONLogPipe(atespace, actorID, containerName string) (io.WriteCloser, error) {
	pr, pw, err := os.Pipe()
	if err != nil {
		return nil, err
	}
	go func() {
		al.WrapContainerLogs(pr, atespace, actorID, containerName)
		pr.Close()
	}()
	return pw, nil
}
...
func (al *ActorLogger) WrapContainerLogs(r io.Reader, atespace, actorID, containerName string) {
