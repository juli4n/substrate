...
type ActorStatus struct {
	...
	// crash_info contains information about why the actor
	// entered CRASHED state and when that happened.
	// Only set if the actor is in CRASHED state.
	//
	// +k8s:optional
	CrashInfo     *ActorCrashInfo `protobuf:"bytes,12,opt,name=crash_info,json=crashInfo,proto3" json:"crash_info,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ActorStatus) GetCrashInfo() *ActorCrashInfo {
	if x != nil {
		return x.CrashInfo
	}
	return nil
...
// ActorCrashInfo contains why and when an Actor crashed.
type ActorCrashInfo struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// crashed_at is when the Actor transitioned to CRASHED.
	//
	// +k8s:required
	CrashedAt *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=crashed_at,json=crashedAt,proto3" json:"crashed_at,omitempty"`
	// message is a human-readable description of the cause of the crash.
	//
	// +k8s:required
	// +k8s:maxLength=2048
...
func (x *ActorCrashInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActorCrashInfo) ProtoMessage() {}

func (x *ActorCrashInfo) ProtoReflect() protoreflect.Message {
	mi := &file_ateapi_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActorCrashInfo.ProtoReflect.Descriptor instead.
func (*ActorCrashInfo) Descriptor() ([]byte, []int) {
	return file_ateapi_proto_rawDescGZIP(), []int{13}
}

func (x *ActorCrashInfo) GetCrashedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CrashedAt
	}
	return nil
...
func (x *ActorCrashInfo) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_ateapi_proto_rawDesc = "" +
	...
	"\x0ecredential_uri\x18\x03 \x01(\tR\rcredentialUri\"\xc0\x04\n" +
	"\vActorStatus\x12(\n" +
	...
	"\x1acurrent_actor_template_uid\x18\v \x01(\tR\x17currentActorTemplateUid\x125\n" +
	"\n" +
	"crash_info\x18\f \x01(\v2\x16.ateapi.ActorCrashInfoR\tcrashInfo\"e\n" +
	"\x0eActorCrashInfo\x129\n" +
	"\n" +
	"crashed_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tcrashedAt\x12\x18\n" +
...
var file_ateapi_proto_goTypes = []any{
	...
	(*ActorCrashInfo)(nil),                     // 22: ateapi.ActorCrashInfo
...
var file_ateapi_proto_depIdxs = []int32{
	...
	22,  // 24: ateapi.ActorStatus.crash_info:type_name -> ateapi.ActorCrashInfo
	109, // 25: ateapi.ActorCrashInfo.crashed_at:type_name -> google.protobuf.Timestamp
