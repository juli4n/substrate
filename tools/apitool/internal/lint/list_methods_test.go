...
func TestListMethodShape(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			findings := lint.ListMethodShape.Check(listAPI(tt.reqFields, tt.respFields))
...
func TestListMethodShape_IgnoresNonListMethods(t *testing.T) {
	...
	if findings := lint.ListMethodShape.Check(api); len(findings) != 0 {
...
func TestListResponseNameMatchesMethod(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			findings := lint.ListResponseNameMatchesMethod.Check(api)
